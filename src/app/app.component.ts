...
@Component({
 ...
 export class AppComponent /*implements OnInit*/{
  ...
  profileForm = new FormGroup({
    fnControll:new FormControl(''),
    lnControll:new FormControl(''),
    address:new FormGroup({
      saControll: new FormControl(''),
      sa2Controll: new FormControl(''),
      cControll: new FormControl(''),
      spControll: new FormControl(''),
      pzControll: new FormControl(''),
    }),
    contacts: new FormGroup({
      pControll: new FormControl(''),
      eControll: new FormControl('')
    })
  });
